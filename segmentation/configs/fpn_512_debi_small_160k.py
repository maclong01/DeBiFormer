...
gpu_multiples=1       #4GPU
#gpu_multiples=2       #8GPU

# optimizer
optimizer = dict(type='AdamW', lr=0.00005*gpu_multiples, weight_decay=0.0001)
...
#4 GPU
runner = dict(type='IterBasedRunner', max_iters=320000//gpu_multiples)
checkpoint_config = dict(by_epoch=False, interval=16000//gpu_multiples)
evaluation = dict(interval=16000//gpu_multiples, metric='mIoU', save_best='mIoU')
