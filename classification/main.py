...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='debi_small', type=str, metavar='MODEL',
                        help='Name of model to train')
    parser.add_argument('--input-size', default=224, type=int, help='images input size')

    parser.add_argument('--drop', type=float, default=0.3, metavar='PCT',
                        help='Dropout rate (default: 0.)')
    parser.add_argument('--drop-path', type=float, default=0.4, metavar='PCT',
    ...
    # Dataset parameters
    parser.add_argument('--data-path', default='/data/ImageNet_minoura', type=str,
                        help='dataset path')
